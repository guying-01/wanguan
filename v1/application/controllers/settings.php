...
class Settings extends CI_Controller {
	...
	//客户等级
	public function custom_level_list() {
		$this->common_model->checkpurview(159);
		$this->load->view('settings/custom_level_list');
	}
	...
	//客户等级新增修改
	public function custom_level_manage() {
		$this->load->view('settings/custom-level-manage');
	}

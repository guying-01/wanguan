...
function markupVension(){
	...
	if(SYSTEM.siType === 1){
		switch(SYSTEM.siVersion){
			case 1:	imgModel.attr('src',imgSrcList.baseTrial).attr('alt','');
				break;
			case 2:	imgModel.attr('src',imgSrcList.baseExp).attr('alt','');
				break;
			case 3: imgModel.attr('src',imgSrcList.base).attr('alt','');//标准版
				break;
			case 4: imgModel.attr('src',imgSrcList.baseExp).attr('alt','');//标准版
				break;
		};
	} else {
		switch(SYSTEM.siVersion){
			case 1:	imgModel.attr('src',imgSrcList.standardTrial).attr('alt','');
				break;
			case 3: imgModel.attr('src',imgSrcList.standard).attr('alt','');//标准版
				break;
			case 4: imgModel.attr('src',imgSrcList.standardExp).attr('alt','');//标准版
				break;
		};
	};
  ...
  <div id="col-main">
    <div id="main-hd" class="cf">
      ...
      <ul class="user-menu">
      	...
      	<li class="space">|</li>-->
      	<!--<li class="qq"><a href="" onClick="return false;" id="wpa">黑锐源码社区</a></li>
      	<li class="space">|</li>
        
      	<li class="telphone">bbs.heirui.cn</li>-->
        <!--<li class="space">|</li>
...
<script src="<?php echo base_url()?>statics/js/dist/default.js?ver=20170814"></script>

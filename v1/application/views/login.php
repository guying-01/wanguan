    ...
    <form action="" onSubmit="return Login()">
        <div class="LoginBox">
            ...
            <div class="Loginc">
                ...
                <!----------changed by Jarod qi 20170804---------->
                <div class="loginInputc">
                    <input type="text" class="logininput" id="cid" value="<?php echo get_cookie('cid')?>" placeholder="商户ID" />
                </div>
                <!----------End 20170804--------------------------->
...
<script type="text/javascript">
    ...
    function Login() {
		...
		if (checkNullOrEmpty(cid)) {
            $("#loginerror").text("请输入商户号").show();
            $("#cid").focus();
            return false;
        }
	
        $('.loading').show();
		var uuu = '/index.php/login?cid='+ cid;
...
//                }
	...
	//add by Jarod qi 20170804 添加PHP 调用JS变量方法
	function p_j()
	{
		//var a = 'db_';
		<?php 
			/*$_SESSION["db_prefix"] = "<script>document.write(a);</script>";*/
			//$_SESSION["db_prefix"] = "db_";
			//echo $c;
		?>
	}
</script>

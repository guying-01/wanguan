...
<head>
	<title>设置独立密码</title>
	<meta charset="utf-8" />
	<link rel="stylesheet" href="http://images.erp.unqq.com/resources/v7/css/phone_validate.css" />
	<script src="http://images.erp.unqq.com/resources/v7/js/jquery.min.js"></script>
	<script type="text/javascript" src="http://images.erp.unqq.com/resources/v7/js/checkPassword.js"></script>
	<script src="http://images.erp.unqq.com/resources/v7/js/phone_validate.js?ver=201403201104"></script>
<style>
...
//	});
	...
	$('#set-password-form').submit(function(){
		...
		$.post('http://service.erp.unqq.com/commonservice/ajaxChecking.do?action=updateBuyerNameForRenew',{
			buyerId: USERID,
			userType: 2,
			buyerMobile: phone,
			...
			if(data && data.toLowerCase() == 'ok'){
				$.post('http://service.erp.unqq.com/user/modifyPassword.do',{

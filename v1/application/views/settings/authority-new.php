...
:disabled;" onpaste="return false;"/>
                ...
                <li class="row-item">
                  ...
                  <div class="ctn-wrap">
                      <div class="ui-combo-wrap" id="staff">
                          <input type="text" class="input-txt" autocomplete="off" id="realName">
                      <i class="trigger"></i></div>
                  </div>
                </li>
                <li class="row-item">
                  <div class="label-wrap">
...
<script src="<?php echo base_url()?>/statics/js/dist/register.js?ver=20170829"></script>
</body>
</html>

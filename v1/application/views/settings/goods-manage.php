        ...
        <div id="manage-wrap" class="manage-wrap">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="discountRate1">折扣一(%)</label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input rate" name="discountRate1" id="discountRate1"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="discountRate2">折扣二(%)</label></div>
...
<script src="<?php echo base_url()?>statics/js/dist/goodsManage.js?ver=20170905"></script>

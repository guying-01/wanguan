		...
		<div class="fl cf" id='tree'>
			...
			<div class="quickSearchField">
				<form class="ui-search" id="searchCategory" onkeydown="if(event.keyCode==13)return false;">
					<input type="text" class="ui-input" id="ckey" placeholder="按名称或编码查询类别" /><button type="button" id="ssan" title="点击搜索" >搜索</button>
				</form>
			</div>
		</div>
	</div>
</div>
<script src="<?php echo base_url()?>statics/js/dist/goodsList.js?ver=20170817"></script>
</body>
</html>

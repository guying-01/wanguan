...
<div class="wrapper">
	<div class="mod-toolbar-top cf">
	    <div class="left">
          ...
          <div id="assisting-category-select" class="ui-tab-select">
            ...
            <ul class="searchbox cf">
		        <li>
		          <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入名称或编码查询">
	    ...
	    <div class="fr"><a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add">新增</a><a href="#" class="ui-btn mrb" id="btn-import" style="display:none">导入</a><a href="#" class="ui-btn mrb" id="btn-export" style="display:none">导出</a><a class="ui-btn" id
...
<script src="<?php echo base_url()?>statics/js/dist/categoryList.js?ver=20170819"></script>

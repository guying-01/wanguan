    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form method="post" action="user_add.php?action=add" onSubmit="return check();">
                    <div class="form-group">
                        <label for="exampleInputEmail1">租户名称</label>
                        <input type="text" class="form-control" id="un" name="zname" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">管理员帐户</label>
                        <input type="text" class="form-control" id="zu" name="zuser" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">联系电话</label>
                        <input type="text" class="form-control" id="pw" name="tel" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">联系地址</label>
                        <input type="text" class="form-control" id="nn"  name="add">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">数据标识</label>
                        <input type="text" class="form-control" id="tp" name="db_prefix">
                    </div>                    
...
if($action=="add")
{
	...
	$zuser = $_POST['zuser'];
	$sql = "INSERT INTO admin_zuser(zname,zuser,tel,address,db_prefix) VALUES ('$zname','$zuser','$tel','$address','$db_prefix')";
	$res = mysql_query($sql) or die("Bad query:".$sql);
	if($res)
	{

		echo "<center>添加成功</center>";

...
function(a) {
	...
	function h(b, c, d) {
		...
		if (float)e.css('float', 'none');
	}
	function i(a) {
		if (a.attr('id') == 'realName') {
            a.parent().parent().find("span.valid-msg").hide(), a.parent().removeClass("input-error")
		} else {
	...
	a("#registerForm input").on("focus", function() {
		...
		("undefined" == typeof a(this).data("valid") || a(this).attr("id") == 'realName') ?
			(g(a(this)), "userName" == a(this).attr("id") && a(this).data("valid") && (a(this).removeData("valid"), i(a(this)), c())) :
			(a(this).data("valid") === !1 && a(this).addClass("input-error"), a(this).parent().find(".valid-msg").show()), a(this).parent().find(".msg").removeClass("msg-focus"), "password" == a(this).attr("id") && a("#pswStrength").hide()
	}).on("change", function() {
	...
	}),m = Business.salesCombo($("#staff"), {
        defaultSelected: 0,
		callback: {
            onChange: function(data){
                a('#realName').trigger("blur");
            }
		}
    });
}(jQuery);